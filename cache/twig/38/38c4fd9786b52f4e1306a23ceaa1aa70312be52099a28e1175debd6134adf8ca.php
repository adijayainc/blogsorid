...
class __TwigTemplate_bfe9e31e9bdfad3395917da4e7f745166ddcb437dd47045dd625aa0958861507 extends \Twig\Template
{
...
";
    ...
    public function block_input($context, array $blocks = [])
    {
        ...
        if (($this->getAttribute($this->getAttribute(($context["field"] ?? null), "selectize", []), "create", []) && ($context["value"] ?? null))) {
            ...
            // line 42
            echo "              ";
            $context["options"] = array_unique(twig_array_merge(($context["options"] ?? null), (((isset($context["custom_value"]) || array_key_exists("custom_value", $context))) ? (_twig_default_filter(($context["custom_value"] ?? null), [])) : ([]))));
            // line 43
            echo "            ";
        }
        // line 44
...
{% endblock %}
", "forms/fields/select/select.html.twig", "/var/www/blogs/user/plugins/form/templates/forms/fields/select/select.html.twig");
    }
}
